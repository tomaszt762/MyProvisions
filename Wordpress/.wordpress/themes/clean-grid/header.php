...
<?php wp_body_open(); ?>
<a class="skip-link screen-reader-text" href="#clean-grid-posts-wrapper"><?php esc_html_e( 'Skip to content', 'clean-grid' ); ?></a>
...
<nav class="clean-grid-nav-primary" id="clean-grid-primary-navigation" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'clean-grid' ); ?>">
<button class="clean-grid-primary-responsive-menu-icon" aria-controls="clean-grid-menu-primary-navigation" aria-expanded="false"><?php esc_html_e( 'Menu', 'clean-grid' ); ?></button>
<?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_id' => 'clean-grid-menu-primary-navigation', 'menu_class' => 'clean-grid-primary-nav-menu clean-grid-menu-primary', 'fallback_cb' => 'clean_grid_fallback_menu', 'container' => '', ) ); ?>
</nav>
...
<div class='clean-grid-top-social-icons'>
    ...
    <a href="<?php echo esc_url( '#' ); ?>" title="<?php esc_attr_e('Search','clean-grid'); ?>" class="clean-grid-social-search-icon"><i class="fa fa-search" aria-hidden="true"></i></a>
</div>
<?php } ?>
