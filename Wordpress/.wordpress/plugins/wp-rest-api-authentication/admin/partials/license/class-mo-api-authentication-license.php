    ...
    public static function emit_css() {
        ...
        <style>
            ...
            .mo-api-license-li.feature-item:before {
                ...
                display: block;
                margin-top: 8px;
                background-image: url("<?php echo $tick_img; ?>");
            ...
            <div class="popup">
              ...
              <div class="container">
                  ...
                  <ul>
                    ...
                    <li class="mo-api-license-li feature-item">
                        Signature Validation : HSA & RSA Signing
                    </li>
                    <li class="mo-api-license-li feature-item">
                        Restrict Public Access to WP REST APIs
                    </li>
        ...
        <div id="oauth-external-providers-authentication" class="overlay">
            <div class="popup">
              ...
              <div class="container">
                  ...
                  <ul>
                    <li class="mo-api-license-li feature-item">
                        Authentication from external OAuth 2.0 providers <br>(Like Azure, Cognito, Firebase Access Token)
                    </li>
                    <li class="mo-api-license-li feature-item">
                        Restrict Public Access to WP REST APIs
                    </li>
        ...
        <div class="container-customize">
            <div class="row">
                ...
                <div class="card text-xs-center">
                    ...
                    <h3 class="display-2"><span class="currency">$</span>149</h3>
                    </div>
                ...
                <div class="card text-xs-center">
                    <div class="card-header">
                    <h3 class="display-2"><span class="currency">$</span>199</h3>
                    </div>
                    <div class="card-block">
                    <h4 class="card-title"> 
            ...
            <div class="row">
                ...
                <div class="card text-xs-center">
                    <div class="card-header">
                    <h3 class="display-2"><span class="currency">$</span>249</h3>
                    </div>
                    <div class="card-block">
                    <h4 class="card-title"> 
                ...
                <div class="card text-xs-center">
                    <div class="card-header">
                    <h3 class="display-2"><span class="currency">$</span>349</h3>
                    </div>
                    <div class="card-block">
                    <h4 class="card-title"> 
            ...
            <div class="row">
                ...
                <div class="card text-xs-center">
                    <div class="card-header">
                    <h3 class="display-2"><span class="currency">$</span>399</h3>
                    </div>
                    <div class="card-block">
                    <h4 class="card-title"> 
                ...
                <div class="card text-xs-center">
                    <div class="card-header">
                    <h3 class="display-2"><span class="currency">$</span>449</h3>
                    </div>
                    <div class="card-block">
                    <h4 class="card-title"> 
                        All Inclusive Plan
